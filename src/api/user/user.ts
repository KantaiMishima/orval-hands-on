 ...
 * @summary Logs user into the system.
 */
export const useLoginUser = <TError = AxiosError<void | void>>(
 ...
 * @summary Get user by user name.
 */
export const useGetUserByName = <TError = AxiosError<void | void | void>>(
 ...
 * @summary Update user resource.
 */
export const useUpdateUser = <TError = AxiosError<void | void | void>>(
 ...
 * @summary Delete user resource.
 */
export const useDeleteUser = <TError = AxiosError<void | void | void>>(
