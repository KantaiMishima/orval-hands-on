 ...
 * @summary Place an order for a pet.
 */
export const usePlaceOrder = <TError = AxiosError<void | void | void>>(
 ...
 * @summary Find purchase order by ID.
 */
export const useGetOrderById = <TError = AxiosError<void | void | void>>(
 ...
 * @summary Delete purchase order by identifier.
 */
export const useDeleteOrder = <TError = AxiosError<void | void | void>>(
